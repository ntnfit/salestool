...
<div class="content">
  <form>
    <div class="row">
      <!-- header input -->
      <x-adminlte-input-date name="fromdate" id="fromdate" label="From Date" :config="$config"  label-class="text-lightblue" igroup-size="sm" fgroup-class="col-md-3" placeholder="Choose a date...">
      ...
      <x-adminlte-input-date name="todate" id="todate" label="To Date" :config="$config"  label-class="text-lightblue" igroup-size="sm" fgroup-class="col-md-3" placeholder="Choose a date...">
                    <x-slot name="appendSlot">
                        <div class="input-group-text bg-gradient-danger">
                            <i class="fas fa-calendar-alt"></i>
                        </div>
      ...
      <x-adminlte-select-bs label="Truck Code"  :config="$configss"  igroup-size="sm" label-class="text-lightblue truckcode" name="truckcode" id="truckcode" igroup-size="sm" fgroup-class="col-md-3" style="margin-left: 150px" enable-old-support>  
        <option value=""></option>
